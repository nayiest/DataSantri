                                ...
                                <div class="tab-content" id="myTabContent">
                                                                ...
                                                                <div class="card-body py-4 px-4">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="ms-3 name">
                                                                            ...
                                                                            <h6 class="text-muted mb-0">{{$item->kategori_prestasi}}</h6>
                                                                            <h6 class="text-muted mb-0">{{$item->keterangan_prestasi}}</h6>
                                                                        </div>
                                                                    </div>
                                                                    <br>
                                                                    
                                                                        <a href="{{ route('editprestasi',$item->id) }}" class="btn icon btn-warning"> Edit</a>
                                                                        <a class="btn icon btn-danger" href="{{route('hapusprestasi',$item->id)}}" onclick="return confirm('Mau Dihapus!?')"> Delete </a>
                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><br>
                                        ...
                                        <table class="table text-start align-right table-bordered table-hover mb-0 ">
                                            ...
                                            <h5 class="card-title">Table Data Prestasi</h5><br>
                                            <thead>
                                                <tr class="text-white">
                                                    <th scope="col">No</th>
