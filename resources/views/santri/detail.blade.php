                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="first-name-column" class="form-control"
                                                                        placeholder="Nama Lengkap" name="nama_santri" value="{{ $santri->nama_santri }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="company-column" class="form-control"
                                                                        name="angkatan_santri" placeholder="angkatan Lengkap" value="{{ $santri->angkatan_santri }}" readonly>
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="domisili_santri" class="form-control" placeholder="Domisili"
                                                                        name="domisili_santri" value="{{ $santri->domisili_santri }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-12">
                                                                <label for="basicInput">Tanggal Lahir</label>
                                                                <input name="tgllahir_santri" id="tgllahir_santri" type="date" class="form-control flatpickr-no-config" value="{{ $santri->tgllahir_santri }}" readonly>                                                                
                                                            </div>
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label for="company-column">ALamat Lengkap</label>
                                                                    <input type="text" id="company-column" class="form-control"
                                                                        name="alamat_santri" placeholder="Alamat Lengkap" value="{{ $santri->alamat_santri }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label for="company-column">Jenis Kelamin Santri</label>
                                                                    <input type="text" id="company-column" class="form-control"
                                                                        name="jk_santri" placeholder="Jenis Kelamin Santri" value="{{ $santri->jk_santri }}" readonly>
                                                                </div>
                                                            </div>
